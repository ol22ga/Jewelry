...
@section('content')
    <div id="CategoryPage">
        ...
        <div class="container">
            <div class="row  mt-5">
                <div class="col-8">
                    <h2 class="text-primary">Бренд</h2>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="AddModalLabel">Создание категории</h5>
        ...
        const CategoryFunctions = {
            ...
            methods: {
                ...
                async Add() {
                    ...
                    const response = await fetch('{{route('BrandAdd')}}', {
                        method: 'post',
                        headers: {
                ...
                //---Удаление категории
                async Delete() {
                    const response = await fetch('{{route('BrandDelete')}}', {
                        method: 'post',
                        headers: {
                            'X-CSRF-TOKEN': '{{csrf_token()}}',
                ...
                async Edit() {
                    ...
                    const response = await fetch('{{route('BrandEdit')}}', {
                        method: 'post',
                        headers: {
                            'X-CSRF-TOKEN': '{{csrf_token()}}',
                        },
