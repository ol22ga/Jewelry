    ...
    <div id="ProductsFunctions">
        ...
        <div class="container">
            <div class="row  mt-5  col-12  text-center">
                <h2>Результаты поиска "@{{ search }}"&nbsp;(@{{ FilterProducts.length }})</h2>
            </div>
            <div class="row  mt-5">
                            ...
                            <div v-for="product in FilterProducts" class="col-12  col-sm-6  col-md-6  col-xl-4">
                                <div class="card  product-card" @click="RenderModalShow(product.id)" data-bs-toggle="modal" data-bs-target="#ShowModal" style="margin-bottom: 24px;">
                                    ...
                                    <div class="card-body" style="display: flex; align-items: flex-start; justify-content: space-between; flex-direction: column">
                                        ...
                                        @auth()
                                            <p v-if="product.product_shops_sum_count == 0 || product.product_shops_sum_count == null" class="card-text" style="text-align: center; width: 100%; height: 38.48px; display: flex; align-items: center; justify-content: center">Нет в наличии</p>
                                            <div v-else style="width: 100%; display: flex; align-items: center; justify-content: space-between; flex-direction: row">
                                                <p class="card-text" style="font-weight: bold; margin: 0; margin-right: 20px;"> @{{product.price}} ₽ </p>
                                                <button type="submit" class="btn  btn-primary" style="width: 50%">В корзину</button>
                                            </div>
                                        @endauth
                                    </div>
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="ShowModalButton" type="button" class="btn  btn-primary">В корзину</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        const ProductsFunctions = {
            ...
            methods: {
                ...
                async GetProducts() {
                    ...
                    this.products = (data.all).filter((product => {
